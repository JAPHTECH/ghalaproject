      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-3 mb-4">
            <div className="w-12 h-12 bg-ghala-green rounded-lg flex items-center justify-center">
              <img 
            ...
            <h1 className="text-3xl font-bold text-gray-900">Ghala</h1>
          </div>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="focus:ring-ghala-green focus:border-ghala-green transition-all duration-200"
                />
              </div>
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full bg-ghala-green hover:bg-ghala-green-dark text-white transition-all duration-200 hover:scale-105 relative overflow-hidden group"
              >
                {isLoading ? (
